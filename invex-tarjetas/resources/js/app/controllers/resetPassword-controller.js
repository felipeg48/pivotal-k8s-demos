app.controller('ResetPasswordController', ['$scope', 'JsonFactory', function($scope,JsonFactory){
    ...
    $scope.submitResetPassword = function(){
    	...
    	JsonFactory.recoverPassword(localStorage.getItem("context"),$scope.recupera).success(function(data){
